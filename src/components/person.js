...
function TwitterLink({ url }) {
  return (
    <a className='mx-2' href={url} aria-label='Twitter'>
      <svg
        className='w-5 h-5 text-slate-200 fill-current dark:text-slate-800 hover:text-slate-400 dark:hover:text-slate-600'
...
function LinkedinLink({ url }) {
  return (
    <a className='mx-2' href={url} aria-label='Linkedin'>
      <svg
        className='w-5 h-5 text-slate-200 fill-current dark:text-slate-800 hover:text-slate-400 dark:hover:text-slate-600'
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 512 512'
